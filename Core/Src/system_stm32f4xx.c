...
void SystemInit(void)
{
	...
	FLASH->ACR |= FLASH_ACR_PRFTEN;	// pre-fetch enable
	...
	// set priority group 4, 16 group priorities. allowing only preemption interrupts
	NVIC_SetPriorityGrouping(0x00000003U);	// zero sub-priority
  ...
  // VOS (voltage scaling) scale 1 for highest frequency
  PWR->CR |= (1U<<14);
